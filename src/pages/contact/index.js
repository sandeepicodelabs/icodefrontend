...
export default function ContactPage() { 
  const handleSubmit = (e) => { 
    ...
    axios
      .get(
        `http://localhost:1337/api/sendingemails?name=${formData.get("name")}&email=${formData.get("email")}&message=${formData.get("message")}`
      )
      .then(async (response) => {
        ...
        <div className="getbox-form">
          <div className="getintouch-form">
            ...
            <p className="gettouch-subheading">
              Send your enquiry and will get back to you within one business day
            </p>
